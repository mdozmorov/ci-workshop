...
```{r}
# Perform GO enrichment analysis of a list of gene names (symbols)
# use use for KEGG of GO enrichment analyses
# Provide which ontology space to use, "MF", "BP", of "CC"
# Returns a list of significant enrichments
#
# Usage: 
# enrichmentGO <- Enrichment(gene_names_list, "GO", , ont="MF")
# enrichmentPW <- Enrichment(gene_names_list, "KEGG")
#
