...
```{r}
symbols<-data.frame(ACCNUM=sapply(Biobase::contents(hgu95av2ACCNUM), paste, collapse=", "), SYMBOL=sapply(Biobase::contents(hgu95av2SYMBOL), paste, collapse=", "), DESC=sapply(Biobase::contents(hgu95av2GENENAME), paste, collapse=", ")) # Get all elements as data frame
